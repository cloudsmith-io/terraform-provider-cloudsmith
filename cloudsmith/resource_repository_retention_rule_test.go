...
var testAccRetentionRepositoryName = testAccUniqueName("terraform-acc-repo-retention-rule")
...
`, testAccRetentionRepositoryName, os.Getenv("CLOUDSMITH_NAMESPACE"))
...
`, testAccRetentionRepositoryName, os.Getenv("CLOUDSMITH_NAMESPACE"), os.Getenv("CLOUDSMITH_NAMESPACE"))
